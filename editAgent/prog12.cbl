      ...
      **** Second line of report ****
       01 header2.
           10      pic x(2).
           10 headfName pic x(13) VALUE "Insureds Name".
           10      pic x(4).
           10 headPhone pic x(12) VALUE "Phone Number".
           10      pic x(4).
      ...
      **** Write the Headers ****
       ...
       CLOSEFILE.
           ...
           MOVE agPrem to ag-prem
           WRITE printRec from AgTotal AFTER ADVANCING 2 LINES.
           CLOSE polFile agentFile polName polRep
           STOP RUN.
