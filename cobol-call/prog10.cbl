      ...
      **** Perform Stop Value ****
       01 endread pic x.
       01 grandTotal-old pic 9(5)v99.
       01 grandTotal-new pic 9(5)v99.
      ...
      **** Second line of report ****
       01 header2.
           ...
           10      pic x(8).
           10      pic x(11) VALUE "Old Premium".
           10      pic x(8).
           10      pic x(11) VALUE "New Premium".
       ...
       01 detailLine.
           ...
           03      pic x(8).
           03 new-prem-out pic ZZZ,ZZ9.99.
      ...
      **** Total Line ****
       01 totalLine.
           03      pic x(21) VALUE "Old Total Amount: ".
           03 tot-out-old pic zz,zzz,zz9.99.
           03      pic x(12).
           03      pic x(21) VALUE "New Total Amount: ".
           03 tot-out-new pic zz,zzz,zz9.99.

      **** Create values to hold new premium amount ****
       ...
       CONT.
           ...
           READ polFile
               INVALID KEY
                   continue
               NOT INVALID KEY
                   MOVE prem-in to new-prem-in
                   CALL "call10" USING polType new-prem-in
                   PERFORM MOVE-VAL
           END-READ.
      ...
      **** Move all read values into an output stream ****
       MOVE-VAL.
           ...
           ADD prem-in to grandTotal-old
           ADD new-prem-in to grandTotal-new
           MOVE prem-in to prem-out
           MOVE new-prem-in to new-prem-out
      ...
      **** Check to add a page if lnCnt > 50 ****
       ...
       CLOSEPROJ.
           MOVE grandTotal-old to tot-out-old
           MOVE grandTotal-new to tot-out-new
